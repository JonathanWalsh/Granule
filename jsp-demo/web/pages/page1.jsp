...
<html>
  <head><title>This is the first struts page</title>
      ...
      <script src="js/closure/goog/base.js"></script>
        ...
        <link rel="stylesheet" href="js/closure/goog/css/menu.css">

        <link rel="stylesheet" href="js/closure/goog/css/menuitem.css">
        <link rel="stylesheet" href="js/closure/goog/css/menuseparator.css">
        <link rel="stylesheet" href="js/closure/goog/css/menubutton.css">
        <link rel="stylesheet" href="js/closure/goog/css/css3button.css">
        <link rel="stylesheet" href="js/closure/goog/css/css3menubutton.css">
        <style>
          ...
          .icon {
            ...
            width: 16px;
            margin: 0 1px;
            background-image: url(js/closure/goog/images/toolbar_icons.gif);
  ...
  <body><a href="ExampleAction.do?go=ex2">Go to the second page</a>
